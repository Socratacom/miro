 ...
 */
function assets() {
  wp_enqueue_style('sage/css', Assets\asset_path('styles/main.css'), '', '4.0.11-beta');
  ...
  wp_enqueue_script('sage/js', Assets\asset_path('scripts/main.js'), ['jquery'], '4.0.11-beta', false);
